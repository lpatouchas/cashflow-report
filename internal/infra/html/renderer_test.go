			...
			ByMonth: []transaction.MonthlyBreakdown{
				{
					...
					Transactions: []transaction.Transaction{
						...
						{ID: "3", Date: time.Date(2026, time.May, 5, 0, 0, 0, 0, time.UTC), Description: "SKROUTZ", Amount: 22, IsDebit: true, SourceFile: "acc.csv", IsVISA: true, Category: "Λοιπές δαπάνες"},
					},
				},
			},
		}
